...
<script type="text/javascript">
    function testAlert(){
        swal("아이디 또는 비밀번호를 다시 확인하세요. 등록되지 않은 아이디이거나, 아이디 또는 비밀번호를 잘못 입력하셨습니다.");
    }
</script>
...
<form id="main2" name ="main2" class="login-form" action="login.do" method="post" onsubmit="return check()">
   <table align="center" >
      ...
      <tr>
          <td></td>
          <td><input type="password" name="pwd" id="pwd" class="text-field style="width: 50% height : 10%;" placeholder="비밀번호를 입력하세요"/>
          <br><span name="check" id="check" ></td>
