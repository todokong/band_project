...
function check() {
	  ...
	  if(searchid.username.value == "") {
		  swal("이름을 입력해 주세요.");	
		  searchid.username.focus();
	    return false;
	  }else if(searchid.phone.value == "") {
		  swal("핸드폰번호를 입력해 주세요.");
		  searchid.phone.focus();
		  return false;  
...
<form id="searchid" name ="searchid" class="login-form" action="findid.do" method="post" onsubmit="return check()">
    ...
    <td> </td>
    <td><input type="text" name="phone" id="phone"  class="phone-number-check1" placeholder="핸드폰번호를 입력해주세요"/></td>
